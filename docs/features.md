...
Para cada solicitud, el proxy seguirá el siguiente proceso:
...
Estas métricas permitirán que el proxy tome decisiones dinámicas y cambie automáticamente de proveedor cuando sea necesario.
